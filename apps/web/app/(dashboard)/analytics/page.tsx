...
import { useRevenueTrend, useTopProducts, useFinancial, useOutletPerformance, useInventoryAnalytics, type TrendPeriod } from '@/hooks/useAnalytics';
...
type Tab = 'sales' | 'outlets' | 'inventory' | 'financial';
  ...
  return (
    <div className="space-y-5">
      <div className="flex gap-2 border-b border-border">
        {([['sales', 'Sales'], ['outlets', 'Outlets'], ['inventory', 'Inventory'], ['financial', 'Financial P&L']] as const).map(([k, l]) => (
